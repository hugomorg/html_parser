defmodule HTMLParser do
  ...
  defp do_parse(parse_state, <<"<">> <> rest, :init) do
    do_parse(parse_state, rest, :parse_open_tag)
  end
  ...
  defp do_parse(parse_state, <<"<", "/">> <> rest, :parse_open_tag) do
    do_parse(parse_state, rest, :parse_close_tag)
  end
  ...
  defp do_parse(parse_state, <<close_tag>> <> rest, :parse_close_tag) do
    parse_state |> ParseState.build_close_tag(<<close_tag>>) |> do_parse(rest, :parse_close_tag)
  end
  ...
  defp do_parse(parse_state, <<" ">> <> rest, :continue) do
    do_parse(parse_state, rest, :continue)
  end
